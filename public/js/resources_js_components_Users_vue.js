...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    updateUser: function updateUser(row) {
      var _this = this;

      this.users.map(function (item, index) {
        item.selected = item === row;

        _this.$set(_this.users, index, item);
      });
      this.$router.push({
        name: "user_detail",
        params: {
    ...
    getUsers: function getUsers() {
      ...
      this.loading = true;
      _utils_request__WEBPACK_IMPORTED_MODULE_0__["default"].get("admin/users/getAll").then(function (response) {
