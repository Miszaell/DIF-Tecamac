...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    post: function post() {
      ...
      _utils_request__WEBPACK_IMPORTED_MODULE_0__["default"].post("admin/documents/post", formData).then(function (response) {
    ...
    put: function put() {
      ...
      _utils_request__WEBPACK_IMPORTED_MODULE_0__["default"].post("admin/documents/put", formData).then(function (response) {
        if (response.data.detail == "success") {
    ...
    del: function del() {
      ...
      formData.append("id", this.record.id);
      _utils_request__WEBPACK_IMPORTED_MODULE_0__["default"].post("admin/documents/delete", formData).then(function (response) {
        if (response.data.detail == "success") {
          _this4.$router.push({
            path: "files"
          });
